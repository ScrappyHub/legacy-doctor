...
$Target = Join-Path $RepoRoot "scripts\selftest\_selftest_ld_fat32_owned_imagefile_v1.ps1"
...
$old = '$DiskSizeBytes = [UInt64]268435456'
$new = '$DiskSizeBytes = [UInt64]4294967296'
