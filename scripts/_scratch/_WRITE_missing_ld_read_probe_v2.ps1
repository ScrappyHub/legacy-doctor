...
$Target = Join-Path $RepoRoot "scripts\storage\ld_read_probe_v1.ps1"
...
Write-Utf8NoBomLf -Path $Target -Text $Script
Parse-GateFile $Target

Write-Host ("WRITE_OK: " + $Target) -ForegroundColor Green