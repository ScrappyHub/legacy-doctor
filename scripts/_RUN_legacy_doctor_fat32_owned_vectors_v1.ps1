...
$Selftest = Join-Path $RepoRoot "scripts\selftest\_selftest_ld_fat32_owned_vectors_v1.ps1"
...
if($joined -notmatch "SELFTEST_LD_FAT32_OWNED_VECTORS_OK"){
  Die "SELFTEST_MISSING_VECTOR_OK" $Selftest
}

Write-Output "LEGACY_DOCTOR_FAT32_OWNED_VECTORS_ALL_GREEN"