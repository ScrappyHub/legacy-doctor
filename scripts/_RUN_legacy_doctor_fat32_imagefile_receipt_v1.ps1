...
$Selftest = Join-Path $RepoRoot "scripts\selftest\_selftest_ld_fat32_imagefile_receipt_v1.ps1"
...
if($joined -notmatch "SELFTEST_LD_FAT32_IMAGEFILE_RECEIPT_OK"){
  Die "SELFTEST_MISSING_RECEIPT_OK" $Selftest
}

Write-Output "LEGACY_DOCTOR_FAT32_IMAGEFILE_RECEIPT_ALL_GREEN"