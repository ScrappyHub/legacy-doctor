...
$Selftest = Join-Path $RepoRoot "scripts\selftest\_selftest_ld_fat32_owned_imagefile_v1.ps1"
...
if($joined -notmatch "SELFTEST_LD_FAT32_OWNED_IMAGEFILE_OK"){
  Die "SELFTEST_MISSING_IMAGEFILE_OK" $Selftest
}

Write-Output "LEGACY_DOCTOR_FAT32_OWNED_IMAGEFILE_ALL_GREEN"