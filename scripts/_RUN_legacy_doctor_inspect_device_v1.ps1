...
$Selftest = Join-Path $RepoRoot "scripts\selftest\_selftest_ld_inspect_device_v1.ps1"
...
if($joined -notmatch "SELFTEST_LD_INSPECT_DEVICE_OK"){
  Die "SELFTEST_MISSING_OK" $Selftest
}

Write-Output "LEGACY_DOCTOR_INSPECT_DEVICE_ALL_GREEN"