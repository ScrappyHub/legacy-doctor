...
$Selftest = Join-Path $RepoRoot "scripts\selftest\_selftest_ld_extract_image_v1.ps1"
...
if($joined -notmatch "SELFTEST_LD_EXTRACT_IMAGE_OK"){
  Die "SELFTEST_MISSING_OK" $Selftest
}

Write-Output "LEGACY_DOCTOR_EXTRACT_IMAGE_ALL_GREEN"